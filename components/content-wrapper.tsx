    ...
    <div className="w-full">
        <WidthWrapper className="my-20">
            <div className={cn("flex flex-col-reverse justify-center md:grid lg:grid-cols-3 md:grid-cols-4 gap-x-10 items-center md:justify-between gap-y-8")}>
                <div className="lg:col-span-1 md:col-span-2 flex flex-col items-start justify-start xl:gap-y-6 lg:gap-y-4 md:gap-y-4 gap-y-4 w-full md:w-auto">
                    ...
                    <p className="font-[400] 2xl:text-3xl xl:text-2xl lg:text-md md:text-sm text-sm w-full text-left ">
                        {desc}
                    </p>
                    <Link href={linkHref}>
